...
class Translator:
    ...
    def _translate_to_target(self,
        ...
        # attentions: (batch_size, heads, output_length, encoded_source_length)
        attentions = mx.nd.zeros((self.batch_size, self.num_heads, target_length, encoded_source_length),
                                  ctx=self.context)
